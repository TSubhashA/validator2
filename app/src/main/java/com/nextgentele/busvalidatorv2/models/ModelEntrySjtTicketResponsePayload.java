...
public class ModelEntrySjtTicketResponsePayload {
    ...
    @Expose
    private Object exitStopBackendKey;
    ...
    @Expose
    private Object exitStopTextualIdentifier;
    ...
    public Object getExitStopBackendKey() {
        return exitStopBackendKey;
    }

    public void setExitStopBackendKey(Object exitStopBackendKey) {
    ...
    public Object getExitStopTextualIdentifier() {
        return exitStopTextualIdentifier;
    }

    public void setExitStopTextualIdentifier(Object exitStopTextualIdentifier) {
